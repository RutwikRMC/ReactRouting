    ...
    <div className="container my-5">
      ...
      <div className="row align-items-center mb-5">
        <div className="col-md-6">
          <h1 className="display-4 fw-bold">Find Your Style</h1>
          <p className="lead mt-3">
            Discover the latest trends in fashion and get your favorite items at amazing prices.
          </p>
          <a href="#shop-now" className="btn btn-primary btn-lg mt-3 gtBtn">Shop Now</a>
        </div>
        <div className="col-md-6">
          <img
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <div className="card h-100 shadow d-flex flex-column">
              ...
              />
              <div className="card-body flex-grow-1">
                <h5 className="card-title">Mans Shooping</h5>
                <p className="card-text">
          ...
          <div className="col-md-4">
            <div className="card h-100 shadow d-flex flex-column">
              ...
              />
              <div className="card-body flex-grow-1">
                <h5 className="card-title">Womens Shooping</h5>
                <p className="card-text">
      ...
      {/* Promotional Section */}
      <div className="text-center py-5 bg-light rounded shadow-lg">
